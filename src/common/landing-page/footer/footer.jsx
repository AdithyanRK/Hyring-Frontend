...
export default function Footer({className}) {
  ...
  >
    ...
    <div className='flex w-full justify-between'>
      ...
      <h2>Job Seekers</h2>
      <p className='text-lg font-primary'>Lorem ipsum dolor sit alam, consectetur adipiscing</p>
      </div>
      ...
      <h2>Employers</h2>
      <p className='text-lg text-right font-primary'>Lorem ipsum dolor sit alam, consectetur adipiscing</p>
      </div>
    </div>
    <motion.div ref={constraintsRef} className='drag-area flex w-[93%] justify-center bg-white rounded-[50px] mt-7 mb-5 border-2 border-primary-brown'>
      ...
      <h2 className='job-title text-lg text-gray-400 self-center ml-5 mr-5 font-primary'>I Need Job</h2>
      ...
      <h2 className='job-title text-lg self-center text-gray-400 mr-5 ml-5 font-primary'>I Need Candidates</h2>
