...
export default function Footer({ className }) {
        ...
        await axios.post(
          ...
          { updateEnabled: false, email: email },
          {
            headers: {
              ...
              "api-key":
                "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",
            },
          }
        );
        setOpenSuccess(true);
  ...
  return (
    <div>
      <div className="md:hidden flex flex-col my-10 px-10 gap-5 font-primary">
        <BoxTheme
          disableAnimate={true}
      ...
      <div className="footer font-primaryMedium w-[95vw] mx-auto border-2 relative border-primary-brown xl:h-[488px] h-full rounded-[30px] pt-10 mt-10 md:pt-20 max-w-[1800px] pb-2 my-0 md:mt-60">
        ...
        <div className="max-w-fit lg:max-w-[1200px] xl:max-w-[1200px] 2xl:max-w-[85%] flex xl:gap-24 items-start md:items-start md:px-4 gap-x-2 md:gap-x-12 justify-center m-auto pt-6 mt-0 sm:mt-5 px-6">
          ...
          <div className="company-sec flex-1 flex flex-col gap-y-5 mb-16">
            ...
            <Link href="/contact-us">
              <p className="text-lg font-primary hover:opacity-70">
                Contact Us
              </p>
            </Link>
            <Link href="/about-us">
        ...
        <div className="mob-soc flex-col gap-y-6 text-center pb-12">
          ...
          <div className="flex flex-col gap-y-7">
            <h2 className="text-[22px]  ">Subscribe Newsletter</h2>
            <div className="flex items-center gap-2 m-auto pb-0">
              <BoxTheme
                top="5px"
                left="4px"
                className={`h-[60px] ${className} w-fit cursor-pointer  text-2xl  `}
