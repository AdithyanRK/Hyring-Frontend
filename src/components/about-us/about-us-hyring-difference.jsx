      ...
      <div className="max-w-[1800px] flex flex-wrap flex-col md:flex-row md:flex-nowrap w-full min-h-[40vh] font-primary z-20">
        <div className="flex-1 bg-[#462B34] text-[#FAFAFA] p-5 md:p-14 flex justify-center md:justify-start items-center flex-col xl:justify-center min-h-[250px]">
          ...
          <p className="text-md md:text-lg lg:text-lg xl:text-xl">
            ...
            <span className="font-semibold">staff augmentation</span> landscape
            by providing access to the{" "}
            <span className="font-semibold">top 5%</span> of rigorously vetted
            IT professionals, ensuring a{" "}
            <span className="font-semibold">fixed commission</span> with{" "}
            <span className="font-semibold">complete transparency</span> on
            salary information for both parties, delivering clear and
            straightforward contracts, and offering state-of-the-art{" "}
