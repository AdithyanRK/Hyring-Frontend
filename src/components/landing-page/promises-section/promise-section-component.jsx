  ...
  return (
    <>
      ...
      >
        <motion.div
          style={{ position, top }}
          className=" absolute hidden md:-left-80 lg:flex z-4  h-screen   justify-center items-center "
        >
        <div className="scale-[0.8] xl:scale-[1]">
          ...
          <div className="w-[700px] h-[700px] border-[1px] border-primary-brown rounded-full bg-[#FDFDFD] shrink-0 flex justify-center items-center relative">
            ...
            <motion.div
              style={{ rotate: rt }}
              className={`w-[600px] h-[400px] z-3 rounded-full absolute -left-3  duration-700  `}
            >
        ...
        <motion.div
         style={{ position, top }}
         className={`  w-screen bg-green-500   z-1   h-screen`}
      ...
      />
        ...
        <motion.div
          style={{ position, top }}
          className={`flex justify-center items-center  w-full py-10 lg:py-12   z-3   gap-1 flex-nowrap left-[50%]  lg:left-[52%] 2xl:left-[50%] -translate-x-2/4`}
      ...
      />
        ...
        <motion.div
          ...
          className="absolute duration-700  left-0 flex justify-center items-center   z-2    h-screen w-screen"
        >
        ...
        <motion.div
          style={{ top: t2 }}
          className="fixed duration-700  left-0 flex justify-center items-center  z-2  h-screen w-screen"
        >
        ...
        <motion.div
          ...
          className="  left-0 flex justify-center items-center z-2  h-screen w-screen"
        >
