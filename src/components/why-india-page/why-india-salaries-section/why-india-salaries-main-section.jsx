        ...
        <div className="w-full  pb-10 lg:pb-20">
          <div className="flex gap-5 flex-col  md:flex-row mb-5 md:mb-10">
            <div className="basis-[40%] h-full">
              <RolesTab activeRole={activeRole} setActiveRole={setActiveRole} Roles={Roles} />
            </div>
  
            <div className="basis-[60%] h-[full] flex flex-col gap-5 md:gap-0 justify-between  ">
              <FilterSalaries setHyringData={setHyringData} setCompetitorData={setCompetitorData} hyringData={hyringData} competitorData={competitorData} />
              <Chart activeRole={activeRole} hyringData={hyringData} competitorData={competitorData}  Roles={Roles}/>
            </div>
          </div>
          <NotesSalraies/>
        </div>
