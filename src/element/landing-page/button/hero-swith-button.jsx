...
export default function HeroAwitchButton({className}) {
  ...
  console.log("🚀 ~ file: hero-swith-button.jsx:9 ~ HeroAwitchButton ~ switchValue:", switchValue)
  ...
  >
    ...
    <div className={` ${!switchValue ? "text-secondary-orange" : "text-custom-grey"} `}>Job</div>
    <MaterialUISwitch onChange={(e)=>SetSwitchValue(e.target.checked)} defaultChecked/>

        <div className={` ${!switchValue ? "text-custom-grey" : "text-secondary-orange"} `}>Candidates</div>
    </div> 
