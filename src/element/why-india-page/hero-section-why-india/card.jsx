      ...
      {cardData.map((data, index) => (
        ...
        >
          <BoxTheme
            ...
            bgBoxStyle={`${
              show == index &&
              `w-full h-[78px] xs:h-[110px] md:h-[130px]  lg:h-[162px] ${data.bg} rounded-[10px] border-2 border-primary-brown`
            }`}
          >
            <div className="pl-2 xs:pl-4 md:pl-[24px]">
              ...
              <div className="font-primaryBold flex items-end xs:text-xl md:text-2xl xl:text-[34px] mt-1 md:mt-4">
                ...
                <span
                  className={
                    index == 1
                      ? "block text-[8px] xs:text-[10px] md:text-xs pb-1 ml-1 xs:pb-0 md:pb-1  xs:ml-2"
                      : "hidden"
                  }
                >
                  (INR)
